...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'ecommerce.views.searchForm',
                'cart.views.category_list',
            ],
        },
    },
]
...
if DEBUG is False:
    ...
    SESSION_CONTENT_TYPE_NOSNIFF = True
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'ecommerce',
            'USER': 'postgres',
            'PASSWORD': 'mypostgrespswd',
            'HOST': 'localhost',
            'PORT': ''
            # PORT number not needed, unless you change the db default port number
        }
    }
